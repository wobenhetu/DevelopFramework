...
public class AudioPlayer
{
    ...
    public void play(String url, final boolean looping, final boolean vibrate) {
        ...
        try {
            ...
            Toast.makeText(mContext, "play失败", Toast.LENGTH_SHORT).show();
        }
    ...
    public void vibrate() {
        ...
        // 第一个参数：前一个代表等待多少毫秒启动vibrator，后一个代表vibrator持续多少毫秒停止。
        // 第二个参数代表震动次数：从repeat索引开始的振动进行循环。-1表示只振动一次，非-1表示从pattern的指定下标开始重复振动。
